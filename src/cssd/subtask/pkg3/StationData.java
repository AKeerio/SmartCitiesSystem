...
public class StationData {
    ...
    */
    public void addRule(Float min, Float max, String Metric, int Id,ActuatorHandler actuator){ 
        station.addRule(max, min, Metric, Id, actuator);
    }
    /*
    ...
    */
    ...
    public void deleteRule(Rule rule,ActuatorHandler actuator){  
        station.deleteRule(rule,actuator);//Not yet implemented
    }
